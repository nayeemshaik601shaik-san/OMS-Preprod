		...
		<ItemList>
			<Item ItemGroupCode="PROD">
				...
				<LanguageDescriptionList Reset="Y">
				 	...
				 	<!-- Remove LanguageDescription entries whose ExtnProductUrl DOES NOT contain www.crocs. -->
				 	<xsl:for-each select="//Item/LanguageDescriptionList/LanguageDescription[@LocaleCode!='en_US' and contains(Extn/@ExtnProductUrl,'www.crocs.')]">
