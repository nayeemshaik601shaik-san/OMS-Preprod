<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	<xsl:template match="/">
		<ItemList>
			...
			<xsl:choose>
				<!--If CrocsItemOrgDataList has CrocsItemOrgData elements -->
				<xsl:when test="//Item/Extn/CrocsItemOrgDataList/CrocsItemOrgData">
				<CrocsItemOrgDataList>
				    ...
				    <xsl:for-each select="//Item/LanguageDescriptionList/LanguageDescription">				
				        ...
				        <xsl:variable name="orgCode">
				            <xsl:choose>
                                ...
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.crocs.co.kr')">crocs_kr</xsl:when>
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.crocs.com.sg')">crocs_sg</xsl:when>
                                ...
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.heydude.com.au')">heydude_au</xsl:when>
                                ...
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.crocs.co.uk')">crocs_gb</xsl:when>
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.crocs.de')">crocs_de</xsl:when>
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.crocs.eu')">crocs_eu</xsl:when>
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.crocs.fi')">crocs_fi</xsl:when>
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.crocs.fr')">crocs_fr</xsl:when>
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.crocs.nl')">crocs_nl</xsl:when>
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.heydude.uk')">heydude_gb</xsl:when>
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.heydude.de')">heydude_de</xsl:when>
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.heydude.eu')">heydude_eu</xsl:when>
                                <xsl:when test="contains(Extn/@ExtnProductUrl,'www.heydude.fr')">heydude_fr</xsl:when>
				...
				<!-- If Updated CrocsItemOrgDataList with No CrocsItemOrgData then Reset Y -->
			    <xsl:otherwise>
