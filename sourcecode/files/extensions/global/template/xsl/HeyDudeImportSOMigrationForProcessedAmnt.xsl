			...
			<PaymentMethods>
				<xsl:for-each select="PaymentMethods/PaymentMethod">
					...
					<PaymentMethod>
						...
						<xsl:attribute name="CreditCardExpDate">1/2500</xsl:attribute>
						<xsl:attribute name="PaymentReference2">HEYDUDEUS</xsl:attribute>
						<xsl:attribute name="PaymentReference4">SHOPIFY</xsl:attribute>
						...
						<PaymentDetailsList>
							<PaymentDetails>
								...
								<xsl:attribute name="TranType">ONLINE-ECOMM</xsl:attribute>
								<xsl:attribute name="ChargeType">CHARGE</xsl:attribute>
								<xsl:attribute name="HoldAgainstBook">Y</xsl:attribute>
								<xsl:attribute name="AuthorizationExpirationDate">2500-06-19T22:37:40Z</xsl:attribute>
