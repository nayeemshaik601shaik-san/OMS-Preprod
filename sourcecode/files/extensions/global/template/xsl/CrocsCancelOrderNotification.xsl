...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org" >
 <xsl:output method="xml" indent="yes"/>
    ...
    <!-- Template to match the root element 'Order' -->
    <xsl:template match="/Order">
        <Order>
            <!-- Copy attributes from 'Order' element -->
            ...
            <xsl:attribute name="OrderPurpose">
                <xsl:value-of select="@OrderPurpose"/>
            </xsl:attribute>
            ...
            <xsl:attribute name="OrderDate">
                ...
                <xsl:value-of select="concat(substring($date-part, 6, 2), '/', substring($date-part, 9, 2), '/', substring($date-part, 1, 4))"/>
            </xsl:attribute>
            ...
            <OrderLines>
                <xsl:for-each select="OrderLines/OrderLine">
                    <OrderLine OriginalOrderedQty="{@OriginalOrderedQty}">
