...
import java.util.Map;
    ...
    public class CrocsCAValidateCancellationCondition implements YCPDynamicConditionEx, CrocsConstant {

    private static YFCLogCategory logger = YFCLogCategory.instance(CrocsCAValidateCancellationCondition.class);

    Map properties = null;

        /**
         * EOMS-9183 Order Ship : Publish Status Update 
		 * This condition will validate whether the message
         * needs to be sent to OIC based on the OrderType & complete cancellation after shipment packed
         *
         * @param env
         * @param indoc
         * @return
    ...
    logger.verbose("CrocsCAValidateCancellationCondition : evaluateCondition : Input is:" + SCXmlUtil.getString(indoc));
        ...
        for (int i = 0; i < orderLine.getLength(); ++i) {
            ...
            String isCancelled = (String) env.getTxnObject("IsCancelled");
            if ("9000".equals(toStatus) && STATUS_INCLUDED_IN_SHIPMENT.equalsIgnoreCase(fromStatus) && "Y".equalsIgnoreCase(isCancelled)) {
                return true;
