package com.crocs.oms.to.shipment;
 ...
 */
public class CrocsTOShipmentPackedToShippedStatusFromWMS extends CrocsCreateShipInputForShipmentUpdatesFromWMS implements CrocsConstant {
    private static final YFCLogCategory logger = YFCLogCategory.instance(CrocsTOShipmentPackedToShippedStatusFromWMS.class);
