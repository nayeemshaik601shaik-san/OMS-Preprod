...
public class CrocsSAPGetItemDetails {

	private static final YFCLogCategory LOGGER = YFCLogCategory.instance(CrocsSAPGetItemDetails.class);
    ...
    public Document crocsCompareItemDetails(YFSEnvironment env, Document indoc) {
