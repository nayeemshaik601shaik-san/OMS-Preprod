 ...
 */
public class CrocsOrderUpdateBcp implements CrocsConstant {
	private static YFCLogCategory logger = YFCLogCategory.instance(CrocsOrderUpdateBcp.class);
			...
			if (YFCCommon.isVoid(strEnterpriseCode) || YFCCommon.isVoid(strDocumentType)
				...
				try {
					...
					if (!YFCCommon.isVoid(eleOrderHoldType)) {
						...
						changeOrderNoteEle.setAttribute(CrocsXmlConstants.A_REASON_CODE,
								CrocsConstant.SFCC_REASON_CODE_VALE);
						changeOrderNoteEle.setAttribute(NOTE_TEXT,
								NOTE_TEXT_VALUE + CrocsConstant.SFCC_REASON_CODE_VALE);
