 ...
 * */
public class CrocsGetOrderDetailLookUp implements CrocsConstant {
    private static YFCLogCategory logger = YFCLogCategory.instance(CrocsGetOrderDetailLookUp.class);
    ...
    public Document processMessage(YFSEnvironment env, Document orderQueryRequestXML)
        ...
        try {
            logger.verbose("CrocsGetOrderDetailLookUp:Request XML for order query: START: " + XMLUtil.getXMLString(orderQueryRequestXML));
            ...
            logger.verbose("CrocsGetOrderDetailLookUp:output from orderQueryResponseXML: " + XMLUtil.getXMLString(orderQueryResponseXML));
        } catch (Exception e) {
