...
import com.crocs.oms.util.ue.CrocsBeforeCreateSOUEImpl;
...
public class CrocsCAMigarationUtil implements CrocsConstant {
	private static final YFCLogCategory logger = YFCLogCategory.instance(CrocsCAMigarationUtil.class);
