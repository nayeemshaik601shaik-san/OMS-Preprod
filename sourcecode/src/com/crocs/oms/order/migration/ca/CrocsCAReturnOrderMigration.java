...
public class CrocsCAReturnOrderMigration implements CrocsConstant {

    private static YFCLogCategory logger = YFCLogCategory.instance(CrocsCAReturnOrderMigration.class.getName());
    ...
    public Document migrationDataValidation(YFSEnvironment env, Document inDoc) throws Exception {
        ...
        try {
            ...
            String [] importROMandatoryAttr= {
                    ...
                    A_ENTERPRISE_CODE,A_ORDER_NO,A_CONDITION_VARIABLE_1,A_RO_MIGRATION_CA_PIPELINE_PROPERTY};
    ...
    private boolean isValidForImportReturnOrderProcesing(YFCElement importOrderYdocEle, String[] importROMandatoryAttr) {
        ...
        for (String ImportROMandatoryAttr: importROMandatoryAttr) {
            if(CrocsCAMigarationUtil.validateMandatoryAttribute(importOrderYdocEle, ImportROMandatoryAttr))
                isValid = true;
            else
                break;
            }
