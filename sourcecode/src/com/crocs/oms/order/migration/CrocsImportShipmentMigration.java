...
public class CrocsImportShipmentMigration implements CrocsConstant{
	private static YFCLogCategory logger = YFCLogCategory.instance(CrocsImportShipmentMigration.class.getName());
	...
	public Document importShipment(YFSEnvironment env, Document importShipmentInDoc) throws Exception {
		...
		try {
			...
			String importShipmentMandatoryAttr[] = { CrocsConstant.A_DOCUMENT_TYPE,
					...
					CrocsConstant.A_SO_SHIPMENT_MIGRATION_PIPELINE_PROPERTY };
			...
			if (isValidForImportOrderProcesingFlag) {
				...
				CrocsMigarationUtil.updateCarrierServiceCode(env,importShipmentYdocEle,importShipmentYdocEle.getAttribute(CrocsConstant.EnterpriseCode));
	...
	private boolean isValidForImportShipmentProcesing(YFCElement importShipmentYdocEle,
			...
			for (String ImportOrderMandatoryAttrtribute : importShipmentMandatoryAttr) {
				...
				if (CrocsMigarationUtil.validateMandatoryAttribute(importShipmentYdocEle,
