...
public class CrocsKRReturnOrderMigration implements CrocsConstant {

    private static YFCLogCategory logger = YFCLogCategory.instance(CrocsKRReturnOrderMigration.class.getName());
     ...
     * <pre>{@code
    <Order DocumentType="0003" EnteredBy="Migration" OrderNo="AAU000088RO" EnterpriseCode="CROCS_KR" OrderDate="2025-04-07T19:21:43+00:00" EntryType="WEB" CustomerEMailID="PBAGLA@CROCS.COM" CustomerFirstName="PRIYANKA" CustomerLastName="BAGLA" CustomerPhoneNo="(403) 718-5340" OtherCharges="6.99">
	...
	<OrderLines>
		<OrderLine OrderedQty="2.00" PrimeLineNo="1" SubLineNo="1" DeliveryMethod="SHP" ReturnReason="301" ConditionVariable1="Migration" OtherCharges="5.0">
			...
			<DerivedFrom DocumentType="0001" EnterpriseCode="CROCS_KR" OrderNo="AULOC000015"/>
			<OrderStatuses>
    ...
    public Document migrationDataValidation(YFSEnvironment env, Document inDoc) throws Exception {
        ...
        try {
            ...
            String [] importROMandatoryAttr= {
                    ...
                    A_ENTERPRISE_CODE,A_ORDER_NO,A_CONDITION_VARIABLE_1,A_RO_MIGRATION_CROCS_KR_PIPELINE_PROPERTY};
    ...
    private boolean isValidForImportReturnOrderProcesing(YFCElement importOrderYdocEle, String[] importROMandatoryAttr) {
        ...
        for (String ImportROMandatoryAttr: importROMandatoryAttr) {
            if(CrocsKRMigarationUtil.validateMandatoryAttribute(importOrderYdocEle, ImportROMandatoryAttr))
                isValid = true;
            else
                break;
            }
