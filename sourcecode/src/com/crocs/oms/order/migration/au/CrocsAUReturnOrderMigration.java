...
public class CrocsAUReturnOrderMigration implements CrocsConstant {

    private static YFCLogCategory logger = YFCLogCategory.instance(CrocsAUReturnOrderMigration.class.getName());
     ...
     * <pre>{@code
    <Order DocumentType="0003" EnteredBy="Migration" OrderNo="AAU000088RO" EnterpriseCode="CROCS_AU" OrderDate="2025-04-07T19:21:43+00:00" EntryType="WEB" CustomerEMailID="PBAGLA@CROCS.COM" CustomerFirstName="PRIYANKA" CustomerLastName="BAGLA" CustomerPhoneNo="(403) 718-5340" OtherCharges="6.99">
	<Extn ExtnSourceCodeGrpId="CrocsClub" ExtnIsCrocsClub="N" ExtnCustId="cust123" ExtnFraudStatus="Y"/>
	<PriceInfo Currency="AUD" EnterpriseCurrency="AUD"  TotalAmount="69.13"/>
	...
	<OrderLines>
		<OrderLine OrderedQty="2.00" PrimeLineNo="1" SubLineNo="1" DeliveryMethod="SHP" ReturnReason="301" ConditionVariable1="Migration" OtherCharges="5.0">
			<Item CostCurrency="AUD" ItemID="10006-001-M20" ItemDesc="original, classic clog, classic, crocs, jjjjound, baya" ItemShortDesc="original, classic clog, classic, crocs, jjjjound, baya" UnitOfMeasure="EACH"/>
			<LineCharges/>
			...
			<DerivedFrom DocumentType="0001" EnterpriseCode="CROCS_AU" OrderNo="AULOC000015"/>
			<OrderStatuses>
		...
		<OrderLine OrderedQty="1.00" PrimeLineNo="2" SubLineNo="1" DeliveryMethod="SHP" ReturnReason="301" ConditionVariable1="Migration" OtherCharges="4.5">
			<Item CostCurrency="AUD" ItemID="10006-001-M44" ItemDesc="original, classic clog, classic, crocs, jjjjound, baya" ItemShortDesc="original, classic clog, classic, crocs, jjjjound, baya" UnitOfMeasure="EACH"/>
			<LineCharges/>
    ...
    public Document migrationDataValidation(YFSEnvironment env, Document inDoc) throws Exception {
        ...
        try {
            ...
            String [] importROMandatoryAttr= {
                    ...
                    A_ENTERPRISE_CODE,A_ORDER_NO,A_CONDITION_VARIABLE_1,A_RO_MIGRATION_CROCS_AU_PIPELINE_PROPERTY};
    ...
    private boolean isValidForImportReturnOrderProcesing(YFCElement importOrderYdocEle, String[] importROMandatoryAttr) {
        ...
        for (String ImportROMandatoryAttr: importROMandatoryAttr) {
            if(CrocsAUMigarationUtil.validateMandatoryAttribute(importOrderYdocEle, ImportROMandatoryAttr))
                isValid = true;
            else
                break;
            }
