...
public class CrocsSGImportShipmentMigration implements CrocsConstant{
	private static YFCLogCategory logger = YFCLogCategory.instance(CrocsSGImportShipmentMigration.class.getName());
...
<Shipment ActualDeliveryDate=""
    ...
    DocumentType="0001" EnteredBy="Migration" EnterpriseCode="CROCS_SG"
    ExpectedDeliveryDate=""
    ExpectedShipmentDate="2025-04-05T08:15:47.000+0000" History="N"
    OrderNo="SGLOC000016" PipelineKey="202504031215582621376"
    ReceivingNode="" ReleaseNo="" SellerOrganizationCode="CROCS_SG"
	...
	public Document importShipment(YFSEnvironment env, Document importShipmentInDoc) throws Exception {
		...
		try {
			...
			String importShipmentMandatoryAttr[] = { CrocsConstant.A_DOCUMENT_TYPE,
					...
					CrocsConstant.A_SO_SHIPMENT_MIGRATION_CROCS_SG_PIPELINE_PROPERTY };
			...
			if (isValidForImportOrderProcesingFlag) {
				...
				CrocsSGMigarationUtil.updateCarrierServiceCode(env,importShipmentYdocEle,importShipmentYdocEle.getAttribute(CrocsConstant.EnterpriseCode));
	...
	private boolean isValidForImportShipmentProcesing(YFCElement importShipmentYdocEle,
			...
			for (String ImportOrderMandatoryAttrtribute : importShipmentMandatoryAttr) {
				...
				if (CrocsSGMigarationUtil.validateMandatoryAttribute(importShipmentYdocEle,
